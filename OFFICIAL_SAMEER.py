...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await idk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await idk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await idk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await ydk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await wdk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await hdk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await sdk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await adk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await adk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await adk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await bdk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await cdk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await ddk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await edk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await edk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await edk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await vkk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await kkk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await lkk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await mkk(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await sid(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await sid(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await sid(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await shy(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await shy(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await shy(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await aan(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await aan(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await aan(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await ake(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await ake(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await ake(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await eel(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await eel(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await eel(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await khu(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await khu(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await khu(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await shi(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await shi(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await shi(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await yaa(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await dav(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await dav(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await dav(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await raj(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await raj(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await raj(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@SH4DOW_COMMUNITY"))
            await put(functions.channels.JoinChannelRequest(channel="@SH4DOW_FIGHTERS"))
            await put(functions.channels.JoinChannelRequest(channel="@SH4DOW_SPAM"))
            await put(functions.channels.JoinChannelRequest(channel="@SH4DOWFIGHTER_CHAT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.s0000000000000000"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.se000000000000000"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.sex00000000000000"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.semx0000000000000"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.semxx000000000000"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.semxxx00000000000"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxx0000000000"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxx000000000"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxx00000000"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxx0000000"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxx000000"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxxx00000"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxxxx0000"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxxxxx000"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxxxxxx00"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxxxxxxx0"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.semxxxxxxxxxxxxxx"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.porn0000000000000"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.pornn000000000000"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.pornnn00000000000"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.pornnnn0000000000"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.pornnnnn000000000"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.pornnnnnn00000000"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.pornnnnnnn0000000"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.pornnnnnnnn000000"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.pornnnnnnnnn00000"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝐒𝐔𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘 𝐉𝐎𝐈𝐍𝐄𝐃")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐆𝐑𝐎𝐔𝐏 𝐉𝐎𝐈𝐍𝐄𝐃 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
USTAD_PIC = "https://telegra.ph/file/f6ca3ddf0593e996dc38d.jpg"
